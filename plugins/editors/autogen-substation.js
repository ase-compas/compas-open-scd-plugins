import { property as u, LitElement as C } from "lit-element";
import { NodePart as I, AttributePart as L, directive as k } from "lit-html";
function z(e, t = "user", n) {
...
function d(e, t, n) {
  ...
  return Object.entries(n).filter(([r, a]) => a !== null).forEach(([r, a]) => i.setAttribute(r, a)), i;
}
function T(e, t) {
...
const P = 1e3 * 60, f = "langChanged";
function H(e, t, n) {
  return Object.entries(N(t || {})).reduce((i, [r, a]) => i.replace(new RegExp(`{{[  ]*${r}[  ]*}}`, "gm"), String(N(a))), e);
}
function V(e, t) {
  const n = e.split(".");
  let i = t.strings;
...
let l = R();
function O(e) {
  return l = Object.assign(Object.assign({}, l), e);
}
function B(e) {
...
async function G(e, t = l) {
  const n = await t.loader(e, t);
  t.translationCache = {}, M(e, n, t);
}
function h(e, t, n = l) {
  let i = n.translationCache[e] || (n.translationCache[e] = n.lookup(e, n) || n.empty(e, n));
  return t = t != null ? N(t) : null, t != null ? n.interpolate(i, t, n) : i;
}
function w(e) {
  return e instanceof I ? e.startNode.isConnected : e instanceof L ? e.committer.element.isConnected : e.element.isConnected;
}
function K(e) {
  for (const [t] of e)
    w(t) || e.delete(t);
...
async function $(e) {
  return Object.keys(S).includes(e) ? S[e] : {};
}
O({ loader: $, empty: (e) => e });
const X = localStorage.getItem("language") || "en";
G(X);
var _ = Object.defineProperty, c = (e, t, n, i) => {
  for (var r = void 0, a = e.length - 1, p; a >= 0; a--)
    (p = e[a]) && (r = p(t, n, r) || r);
  return r && _(t, n, r), r;
};
let Q = 1, Y = 1;
...
function ee(e) {
  return e.getAttribute("prefix") && e.getAttribute("inst") ? e.getAttribute("prefix") + e.getAttribute("inst") : e.getAttribute("inst") && y(e) === "CBR" ? "QA" + Q++ : "QB" + Y++;
}
function te(e, t) {
  if (Array.from(
...
function ie(e, t) {
  return e.parentElement ? ne(e).filter((n) => te(n, t)) : [];
}
class m extends C {
  constructor() {
  ...
  async run() {
    ...
    this.iedNames = Array.from(this.doc.querySelectorAll("IED")).map((i) => i.getAttribute("name") || "").filter((i) => !t.includes(i));
   ...
   */
  createVoltageLevels(t, n) {
    const i = this.iedNames.filter((a) => a.includes(n)).map((a) => a?.substring(this.substationNameLength)), r = this.extractNames(
      i.map(
    ...
    this.createLog(
      ...
      ), b = i.filter((o) => o?.startsWith(a)).map(
        (o) => o?.substring(this.voltageLevelNameLength, o.length)
      );
      this.createBays(s, b, n + a), t.appendChild(s);
    });
  }
  /**
  ...
  createBays(t, n, i) {
    const r = this.extractNames(
      n.map((a) => a.split(this.iedStartChar)[0])
    );
    this.createLog(
      r.length == 0 ? 1 : 0,
      ...
      n.filter(
        ...
        const b = this.doc.querySelector(
          `IED[name=${i + s}]`
        ), o = this.createLNodeElements(b, [
          "sbo-with-enhanced-security"
        ]);
        o ? o.forEach((v) => g.appendChild(v)) : g.prepend(this.addDefaultLNodes(b));
      }), t.appendChild(g);
    });
  }
  /**
   ...
   */
  createLNodeElements(t, n) {
    const i = ie(t, n);
    return i.length ? i.map((a) => J(
   ...
   */
  addDefaultLNodes(t) {
    const n = t.querySelector("LN0");
    return d(t.ownerDocument, "LNode", {
...
c([
  u()
], m.prototype, "iedNames");
c([
  u()
], m.prototype, "substationNameLength");
c([
  u()
], m.prototype, "voltageLevelNameLength");
c([
  u()
], m.prototype, "iedStartChar");
export {
  m as default
};
